function t(e) {
    ...
    this.I_InitPlugin = function (t, n, o) {
        ...
        return null == c && null == c.object ? -1 :
            ("object" == typeof e.attachEvent && f.browser().msie &&
                (c.attachEvent("GetSelectWndInfo", this.GetSelectWndInfo),
                    c.attachEvent("ZoomInfoCallback", this.ZoomInfoCallback),
                    c.attachEvent("GetHttpInfo", this.GetHttpInfo),
                    c.attachEvent("PluginEventHandler", this.PluginEventHandler),
                    c.attachEvent("RemoteConfigInfo", this.RemoteConfigInfo),
                    c.attachEvent("KeyBoardEventInfo", this.KeyBoardEventInfo)
                ), U(), 0)
    ...
    this.I_Login = function (t, r, s, o, i, a) {
        ...
        if (f.extend(P, t), -1 != r) {
            ...
            if (re()) {
                ...
                I == W &&
                    h.oStreamCapa.bSupportShttpPlay ? (_("SHTTP RealPlay"),
                        ...
                        l = !0,
                        B(P.iPort) ? (
                            "https://" == h.szHttpProtocol ? (-1 == h.iHttpPort && (h.iHttpPort = J(h).iHttpPort), i = h.iHttpPort) : i = h.iCGIPort
    ...
    var n = this;
    n.version = "1.1.0"
    return o = "webVideoCtrl" + new t().id,
        i = "webVideoCtrl" + he,
        "object" != typeof e.attachEvent &&
        f.browser().msie &&
        (
            f.createEventScript(o, "GetSelectWndInfo(SelectWndInfo)", "$(this).parent()[0].GetSelectWndInfo(SelectWndInfo);"),
            f.createEventScript(o, "ZoomInfoCallback(szZoomInfo)", "$(this).parent()[0].ZoomInfoCallback(szZoomInfo);"),
            f.createEventScript(o, "GetHttpInfo(lID, lpInfo, lReverse)", "$(this).parent()[0].GetHttpInfo(lID, lpInfo, lReverse);"),
            f.createEventScript(o, "PluginEventHandler(iEventType, iParam1, iParam2)", "$(this).parent()[0].PluginEventHandler(iEventType, iParam1, iParam2);"),
            f.createEventScript(o, "RemoteConfigInfo(lID)", "$(this).parent()[0].RemoteConfigInfo(lID);"),
            f.createEventScript(o, "KeyBoardEventInfo(iKeyCode)", "$(this).parent()[0].KeyBoardEventInfo(iKeyCode);")
        ),
        this
}
